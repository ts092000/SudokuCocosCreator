          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                ...
                var rowIndex = Math.floor(_this.selectedNode.position.y / 55);
                var colIndex = Math.floor(_this.selectedNode.position.x / 55);
                var value = parseInt(labelBlock.string);

                if (value === 0) {
                  var solutionValue = solutionGame[rowIndex * 9 + colIndex];
...
//# sourceMappingURL=5d8ff4ef1374b6e93f769c93f526e5bca47ec475.js.map