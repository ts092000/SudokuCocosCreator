                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (var _i3 = 0; _i3 < 9; _i3++) {
                      if (_i3 !== row) {
                        ...
                        if (_this3.frameNodeArray.length > 20) {
                          for (var _i4 = 0; _i4 < _this3.frameNodeArray.length - 1; _i4++) {
                        ...
                        } else if (_this3.frameNodeArray.length == 21) {
                          _this3.frameNodeArray.splice(-21);
                        }
                      }
                    }
                    ...
                    for (var _j = 0; _j < 9; _j++) {
                      if (_j !== col) {
                        ...
                        if (_this3.frameNodeArray.length > 20) {
                          for (var _i5 = 0; _i5 < _this3.frameNodeArray.length - 1; _i5++) {
                    ...
                    for (var _i6 = rowStart; _i6 < rowStart + 3; _i6++) {
                      for (var _j2 = colStart; _j2 < colStart + 3; _j2++) {
                        if (_i6 !== row && _j2 !== col) {
                          ...
                          if (_this3.frameNodeArray.length > 20) {
                            for (var _i7 = 0; _i7 < _this3.frameNodeArray.length - 1; _i7++) {
...
//# sourceMappingURL=5d260a970adf4ea999a9299dffba56d50bebac45.js.map