                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (var _i3 = 0; _i3 < 9; _i3++) {
                      if (_i3 !== row) {
                        ...
                        _this3.frameNodeArray.push(nodePrefab); // if (this.frameNodeArray.length > 1) {
                        //     this.frameNodeArray[this.frameNodeArray.length - 2].destroy();
                        // }
                    ...
                    for (var _j = 0; _j < 9; _j++) {
                      if (_j !== col) {
                        ...
                        _this3.frameNodeArray.push(_nodePrefab); // if (this.frameNodeArray.length > 1) {
                        //     this.frameNodeArray[this.frameNodeArray.length - 2].destroy();
                        // }
                    ...
                    for (var _i4 = rowStart; _i4 < rowStart + 3; _i4++) {
                      for (var _j2 = colStart; _j2 < colStart + 3; _j2++) {
                        if (_i4 !== row && _j2 !== col) {
                          var _node2 = _this3.gameView.BoardNode.getChildByName("ValueGame" + (_i4 * 9 + _j2));
                          ...
                          _this3.frameNodeArray.push(_nodePrefab2); // if (this.frameNodeArray.length > 1) {
                          //     this.frameNodeArray[this.frameNodeArray.length - 2].destroy();
                          // }
              ...
              nodeNum.on(Node.EventType.TOUCH_END, () => {
                if (_this3.selectedNode) {
                  ...
                  if (!isNaN(selectedValue)) {
                    ...
                    var _i5 = Math.floor(_this3.selectedNode.position.x / 55);
...
//# sourceMappingURL=3e98423060dae1344c698dbd493908b558472c3d.js.map