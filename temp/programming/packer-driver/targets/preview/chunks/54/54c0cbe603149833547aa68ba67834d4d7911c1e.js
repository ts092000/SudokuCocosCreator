        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              var prevValue = null; // Khởi tạo biến lưu trữ giá trị trước đó của ô số
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  labelBlock.string = "-";
                  console.log(emtyNode);
                } else if (_this.selectedNode !== nodeSudoku && prevValue !== null) {
...
//# sourceMappingURL=54c0cbe603149833547aa68ba67834d4d7911c1e.js.map