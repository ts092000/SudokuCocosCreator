        ...
        createPuzzleBoard() {
          ...
          for (var _i2 = 0; _i2 < 9; _i2++) {
            ...
            var _loop = function _loop() {
              ...
              var currentPrefabInstance = null; // Khởi tạo biến toàn cục để lưu trữ prefab hiện tại

              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (currentPrefabInstance) {
                    // Nếu đã có prefab được tạo trước đó, xóa nó khỏi scene
                    currentPrefabInstance.destroy();
                    currentPrefabInstance = null;
                  } // Tạo prefab mới và lưu trữ vào biến toàn cục


                  currentPrefabInstance = instantiate(_this.frameNode);

                  _this.node.addChild(currentPrefabInstance); // Cập nhật vị trí của prefab theo vị trí của node được chọn


                  currentPrefabInstance.setPosition(nodeSudoku.position);
                }
              });
...
//# sourceMappingURL=a3170f05dcc7edaefd7683eb7d19f1ac2850db17.js.map