              ...
              if (_this.selectedNode) {
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  if (!isCorrect) {
                    ...
                    if (!isEmtyNodeMinus) {
                      // nếu chưa trừ emtyNode
                      emtyNode--;
                      isEmtyNodeMinus = true; // đánh dấu là đã trừ emtyNode
                    }
                  } else {
                    labelBlock.color = Color.BLUE;

                    if (labelBlock.color.equals(Color.BLUE) && !isEmtyNodeMinus) {
                      // nếu labelBlock màu xanh và chưa trừ emtyNode
                      emtyNode--;
                      isEmtyNodeMinus = true; // đánh dấu là đã trừ emtyNode
                    }
...
//# sourceMappingURL=47d660a58d5d4d4b3334fa7a405cd90d570ad7a8.js.map