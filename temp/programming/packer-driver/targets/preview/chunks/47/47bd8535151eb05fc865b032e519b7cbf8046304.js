System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, VerticalTextAlignment, Label, Vec3, Color, director, AudioClip, AudioSource, Prefab, instantiate, find, SudokuCreator, GameView, StoredPersistNode, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, GameController;
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var audioParam = _this2.AudioBg.getComponent(AudioSource);

            console.log(audioParam);
            _this2.AudioBg = audioParam;
            console.log(_this2.AudioBg);
...
//# sourceMappingURL=47bd8535151eb05fc865b032e519b7cbf8046304.js.map