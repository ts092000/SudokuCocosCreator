System.register(["__unresolved_0", "cc", "@dattenlagiday/oc_gamecenter_sdk_pkg"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, AudioSource, GameClient, _dec, _class, _crd, ccclass, property, StoredPersistNode;
      ...
      _export("StoredPersistNode", StoredPersistNode = (_dec = ccclass('StoredPersistNode'), _dec(_class = class StoredPersistNode extends Component {
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.AudioBg = _this.AudioBg.getComponent(AudioSource);
            console.log(_this.AudioBg); // this.gameClient = new GameClient("643fc5fe0a3bf6132391328d", "568a590d-f9d1-4a10-b59d-ea6e0d9e9786");
          })();
        }
...
//# sourceMappingURL=ae28693c928ba82ffe7ac760b70f0855e035dccb.js.map