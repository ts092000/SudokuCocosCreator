              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (prevSelectedNode && prevSelectedNode !== nodeSudoku) {
                    ...
                    for (var _i3 = 0; _i3 < 81; _i3++) {
                      var node = _this.boardNode.getChildByName("ValueGame" + _i3);
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (var _i4 = 0; _i4 < 9; _i4++) {
                      if (_i4 !== row) {
                        var _node = _this.boardNode.getChildByName("ValueGame" + (_i4 * 9 + j));

                        var nodePrefab = instantiate(_this.frameNode);
                        nodePrefab.setPosition(_node.position);

                        _node.parent.addChild(nodePrefab);
                      }
                    }
                    ...
                    for (var _j = 0; _j < 9; _j++) {
                      if (_j !== col) {
                        var _node2 = _this.boardNode.getChildByName("ValueGame" + (i * 9 + _j));

                        var _nodePrefab = instantiate(_this.frameNode);

                        _nodePrefab.setPosition(_node2.position);

                        _node2.parent.addChild(_nodePrefab);
                      }
                    }
                    ...
                    for (var _i5 = rowStart; _i5 < rowStart + 3; _i5++) {
                      for (var _j2 = colStart; _j2 < colStart + 3; _j2++) {
                        if (_i5 !== row && _j2 !== col) {
                          var _node3 = _this.boardNode.getChildByName("ValueGame" + (_i5 * 9 + _j2));

                          var _nodePrefab2 = instantiate(_this.frameNode);

                          _nodePrefab2.setPosition(_node3.position);

                          _node3.parent.addChild(_nodePrefab2);
                        }
                      }
                    }
                  }
...
//# sourceMappingURL=ef8f8af991c9d81b2b818df9842c515742ae6d0d.js.map