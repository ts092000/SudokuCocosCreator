        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              var prevValue = "     "; // Khởi tạo biến lưu trữ giá trị trước đó của ô số

              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  _this.selectedNode = nodeSudoku;
                  prevValue = labelBlock.string !== "-" ? labelBlock.string : prevValue; // Lưu trữ giá trị trước đó nếu ô số chưa nhập số

                  labelBlock.string = "-";
                  console.log(emtyNode);
                } else if (_this.selectedNode !== nodeSudoku && prevValue !== "     ") {
                  _this.selectedNode.string = prevValue;
                  labelBlock.string = prevValue;
                  prevValue = "     ";
                }
              });
            };
...
//# sourceMappingURL=ef89641645f70f83dcd453b3755a728022833a2a.js.map