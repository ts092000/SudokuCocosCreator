    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        constructor() {
          ...
          this.frameNodeArray1 = [];
          this.frameNodeArray2 = [];
          this.frameNodeArray3 = [];
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (var _i3 = 0; _i3 < 9; _i3++) {
                      if (_i3 !== row) {
                        ...
                        _this3.frameNodeArray1.push(nodePrefab);

                        console.log(_this3.frameNodeArray1);

                        if (_this3.frameNodeArray1.length > 20) {
                          for (var _i4 = 0; _i4 < 20; _i4++) {
                            _this3.frameNodeArray1[_i4].destroy();
                          }
                        }

                        if (_this3.frameNodeArray1.length > 20) {
                          _this3.frameNodeArray1.splice(-20);
                        } // else if (this.frameNodeArray1.length == 21) {
                        //     this.frameNodeArray1.splice(-21);
                        // }
                    ...
                    for (var _j = 0; _j < 9; _j++) {
                      if (_j !== col) {
                        ...
                        _this3.frameNodeArray2.push(_nodePrefab);

                        console.log(_this3.frameNodeArray2);

                        if (_this3.frameNodeArray2.length > 20) {
                          for (var _i5 = 0; _i5 < 20; _i5++) {
                            _this3.frameNodeArray2[_i5].destroy();
                          }
                        }

                        if (_this3.frameNodeArray2.length > 20) {
                          _this3.frameNodeArray2.splice(-20);
                        } // else if (this.frameNodeArray2.length == 21) {
                        //     this.frameNodeArray2.splice(-21);
                        // }
                    ...
                    for (var _i6 = rowStart; _i6 < rowStart + 3; _i6++) {
                      for (var _j2 = colStart; _j2 < colStart + 3; _j2++) {
                        if (_i6 !== row && _j2 !== col) {
                          ...
                          _this3.frameNodeArray3.push(_nodePrefab2);

                          console.log(_this3.frameNodeArray3);

                          if (_this3.frameNodeArray3.length > 20) {
                            for (var _i7 = 0; _i7 < 20; _i7++) {
                              _this3.frameNodeArray3[_i7].destroy();
                            }
                          }

                          if (_this3.frameNodeArray3.length > 20) {
                            _this3.frameNodeArray3.splice(-20);
                          } // else if (this.frameNodeArray3.length == 21) {
                          //     this.frameNodeArray3.splice(-21);
                          // }
...
//# sourceMappingURL=a1661f6e39cbcaba025dee02874a0291acc82e91.js.map