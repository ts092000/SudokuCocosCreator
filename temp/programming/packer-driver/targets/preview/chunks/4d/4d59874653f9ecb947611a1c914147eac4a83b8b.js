                  ...
                  if (!nodeCheck[_i3][_j].filled) {
                    if (isCorrect == true) {
                      ...
                      if (emtyNode === 0) {
                        ...
                        _this3.gameView.SelectNode.pause(); // this.gameView.BgMain.getComponent(AudioSource).pause();      
                    ...
                    if (_this3.redNumber == 4) {
                      ...
                      _this3.gameView.SelectNode.pause();
...
//# sourceMappingURL=4d59874653f9ecb947611a1c914147eac4a83b8b.js.map