                ...
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    var _loop3 = function _loop3() {
                      if (_i3 !== row) {
                        var _node2 = _this.boardNode.getChildByName("ValueGame" + (_i3 * 9 + j));
                    ...
                    for (var _j = 0; _j < 9; _j++) {
                      if (_j !== col) {
                        var node = _this.boardNode.getChildByName("ValueGame" + (i * 9 + _j));
                    ...
                    for (var _i4 = rowStart; _i4 < rowStart + 3; _i4++) {
                      for (var _j2 = colStart; _j2 < colStart + 3; _j2++) {
                        if (_i4 !== row && _j2 !== col) {
                          var _node = _this.boardNode.getChildByName("ValueGame" + (_i4 * 9 + _j2));
...
//# sourceMappingURL=0af62cd298ef9d03e615469a8a14ded1ec87b57c.js.map