              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    console.log(_this3.nodePositionArray);
                    console.log(_this3.frameNodeNumArray);
                    ...
                    for (var _i3 = 0; _i3 < 9; _i3++) {
                      if (_i3 !== row) {
                        ...
                        if (_this3.frameNodeArray.length > _this3.frameNodeArray.length + 20) {
                          for (var _i4 = _this3.frameNodeArray.length; _i4 < _this3.frameNodeArray.length + 20; _i4++) {
                            console.log(_this3.frameNodeArray[_i4 - 1]);

                            _this3.frameNodeArray[_i4].destroy();
                          } // this.frameNodeArray = [];                           
                    ...
                    for (var _j = 0; _j < 9; _j++) {
                      if (_j !== col) {
                        ...
                        if (_this3.frameNodeArray.length > _this3.frameNodeArray.length + 20) {
                          for (var _i5 = _this3.frameNodeArray.length; _i5 < _this3.frameNodeArray.length + 20; _i5++) {
                            console.log(_this3.frameNodeArray[_i5 - 1]);

                            _this3.frameNodeArray[_i5].destroy();
                          } // this.frameNodeArray = [];                                 
                    ...
                    for (var _i6 = rowStart; _i6 < rowStart + 3; _i6++) {
                      for (var _j2 = colStart; _j2 < colStart + 3; _j2++) {
                        if (_i6 !== row && _j2 !== col) {
                          ...
                          if (_this3.frameNodeArray.length > _this3.frameNodeArray.length + 20) {
                            for (var _i7 = _this3.frameNodeArray.length; _i7 < _this3.frameNodeArray.length + 20; _i7++) {
                              console.log(_this3.frameNodeArray[_i7 - 1]);

                              _this3.frameNodeArray[_i7].destroy();
                            } // this.frameNodeArray = [];              
...
//# sourceMappingURL=d7a90df631100e857b3bdf0c09160c4acd8d5bae.js.map