      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var audioNode = find("BackgroundAudio");
            var audioParam = audioNode.getComponent(_crd && StoredPersistNode === void 0 ? (_reportPossibleCrUseOfStoredPersistNode({
              error: Error()
            }), StoredPersistNode) : StoredPersistNode);
            _this2.AudioBg = audioParam.AudioBg;
...
//# sourceMappingURL=7c86fa2c9b43088749b270c4cbe70d1bfb20f0d4.js.map