System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, VerticalTextAlignment, Label, Vec3, Color, Sprite, Button, director, AudioClip, AudioSource, Slider, SudokuCreator, GameView, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _descriptor21, _descriptor22, _descriptor23, _crd, ccclass, property, GameController;
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "settingVolumeBg", _descriptor18, this);

          _initializerDefineProperty(this, "settingVolumeEffect", _descriptor19, this);

          _initializerDefineProperty(this, "timerLabel", _descriptor20, this);

          _initializerDefineProperty(this, "levelLabel", _descriptor21, this);

          _initializerDefineProperty(this, "winGame", _descriptor22, this);

          _initializerDefineProperty(this, "bestTime", _descriptor23, this);
        ...
        start() {// let storedTimeBest = localStorage.getItem('timeBestArr');
          // if (storedTimeBest) {
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  if (!isCorrect) {
                    ...
                    if (_this.redNumber === 4) {
                      ...
                      localStorage.setItem('score', JSON.stringify(_this.timeBestArr));
                      var bestTime = Math.min(..._this.timeBestArr);
                    ...
                    if (emtyNode === 0) {
                      ...
                      var _bestTime = Math.min(..._this.timeBestArr);

                      console.log(_bestTime);
                      _this.bestTime.string = 'best Time: ' + _bestTime;
        ...
        writable: true,
        initializer: null
      }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "settingVolumeBg", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, "settingVolumeEffect", [_dec20], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, "timerLabel", [_dec21], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, "levelLabel", [_dec22], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, "winGame", [_dec23], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor23 = _applyDecoratedDescriptor(_class2.prototype, "bestTime", [_dec24], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=ca6dbe30eb0c97f3751d66ce6a88fdc970b21d2e.js.map