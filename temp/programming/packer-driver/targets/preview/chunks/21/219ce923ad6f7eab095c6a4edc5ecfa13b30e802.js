              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    // Node đã được đánh dấu trước đó, di chuyển prefab tới vị trí của node đó
                    var _prefabInstance = _this.frameNode.parent.getChildByName(nodeSudoku.name);
...
//# sourceMappingURL=219ce923ad6f7eab095c6a4edc5ecfa13b30e802.js.map