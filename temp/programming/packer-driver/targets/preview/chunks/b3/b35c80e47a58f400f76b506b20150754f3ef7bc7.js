                  ...
                  if (!nodeCheck[_i3][_j].filled) {
                    if (isCorrect == true) {
                      ...
                      if (emtyNode === 0) {
                        ...
                        _this3.gameView.SelectNode.stop(); // this.gameView.BgMain.getComponent(AudioSource).pause();      
                    ...
                    if (_this3.redNumber == 4) {
                      ...
                      _this3.gameView.SelectNode.stop();
...
//# sourceMappingURL=b35c80e47a58f400f76b506b20150754f3ef7bc7.js.map