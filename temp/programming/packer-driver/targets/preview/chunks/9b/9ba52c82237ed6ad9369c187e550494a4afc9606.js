              ...
              nodeNum.on(Node.EventType.TOUCH_END, () => {
                if (_this.selectedNode) {
                  ...
                  if (!isNaN(selectedValue)) {
                    ...
                    if (_labelBlock.color === Color.BLUE) {
                      // If the label is blue, do nothing and exit the event listener
                      return;
                    }
...
//# sourceMappingURL=9ba52c82237ed6ad9369c187e550494a4afc9606.js.map