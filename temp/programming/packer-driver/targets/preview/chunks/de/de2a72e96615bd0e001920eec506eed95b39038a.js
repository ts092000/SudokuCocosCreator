System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku", "__unresolved_1", "@dattenlagiday/oc_gamecenter_sdk_pkg"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, VerticalTextAlignment, Label, Vec3, Color, Sprite, Button, director, AudioClip, AudioSource, Slider, Prefab, instantiate, SudokuCreator, GameView, GameClient, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _descriptor21, _descriptor22, _descriptor23, _descriptor24, _descriptor25, _descriptor26, _descriptor27, _descriptor28, _descriptor29, _crd, ccclass, property, GameController;
          ...
          return _asyncToGenerator(function* () {
            if (_this.gameClient === undefined) {
              _this.gameClient = new (_crd && GameClient === void 0 ? (_reportPossibleCrUseOfGameClient({
                error: Error()
              }), GameClient) : GameClient)("642d35b6dc7fdb5a28069ce7", "1258a0fa-9b29-4162-8c27-73fa014545f7");
              yield _this.gameClient.initAsync().then(() => {
                console.log(_this.gameClient.match);
            ...
            if (saveVolumeBg) {
              _this.volumeBg = JSON.parse(saveVolumeBg);
              _this.bgMain.getComponent(AudioSource).volume = _this.volumeBg[_this.volumeBg.length - 1];
              _this.settingVolumeBg.progress = _this.volumeBg[_this.volumeBg.length - 1];
            }

            console.log(_this.settingVolumeBg.progress);
            var saveVolumeEffect = localStorage.getItem('volumeEffect');

            if (saveVolumeEffect) {
              _this.volumeEffect = JSON.parse(saveVolumeEffect);
              _this.settingVolumeEffect.progress = _this.volumeEffect[_this.volumeEffect.length - 1];
            }
          })();
        }
...
//# sourceMappingURL=de2a72e96615bd0e001920eec506eed95b39038a.js.map