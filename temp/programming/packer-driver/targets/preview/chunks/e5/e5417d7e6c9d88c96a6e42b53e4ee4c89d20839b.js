        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              var blueEntered = false; // nodeSudoku.on(Node.EventType.TOUCH_END, () => {
              //     if (value === 0) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  labelBlock.string = "-";
                  console.log(emtyNode);
                } else if (labelBlock.color === Color.BLUE) {
                  if (firstBlue && emtyNode > 0) {
                    firstBlue = false;
                    emtyNode--;
                  }
                }
...
//# sourceMappingURL=e5417d7e6c9d88c96a6e42b53e4ee4c89d20839b.js.map