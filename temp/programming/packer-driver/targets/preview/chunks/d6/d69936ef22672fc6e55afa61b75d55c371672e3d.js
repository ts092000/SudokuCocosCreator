            ...
            var _loop = function _loop() {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  var existingPrefabInstance = nodeSudoku.getChildByName("PrefabInstance");

                  if (existingPrefabInstance) {
                    existingPrefabInstance.destroy();
                  } else {
                    var prefabInstance = instantiate(_this.frameNode);
                    prefabInstance.name = "PrefabInstance";
                    prefabInstance.setPosition(nodeSudoku.position);
                    nodeSudoku.addChild(prefabInstance);
                  }
                }
              });
...
//# sourceMappingURL=d69936ef22672fc6e55afa61b75d55c371672e3d.js.map