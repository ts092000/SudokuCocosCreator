            ...
            var _loop2 = function _loop2(j) {
              ...
              nodeNum.on(Node.EventType.TOUCH_END, () => {
                if (_this.selectedNode) {
                  var solutionValue = _this.solutionGame[i * 9 + j];

                  var _labelBlock = _this.selectedNode.getComponent(Label);

                  _labelBlock.string = label.string;
                  console.log(solutionValue[i * 9 + j]);
                  console.log(label.string); // labelBlock.color = Color.BLACK;

                  if (label.string === solutionValue[i * 9 + j].toString()) {
...
//# sourceMappingURL=59a46b526839e20ceb893c3f803fb266021d8921.js.map