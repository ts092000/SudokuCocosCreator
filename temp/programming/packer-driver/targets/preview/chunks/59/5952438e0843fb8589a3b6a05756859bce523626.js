              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (_this.frameNode) {
                    ...
                    _this.frameNode.setPosition(nodeSudoku.position);

                    _this.frameNode = null; // Deselect the prefab
                  } else {
...
//# sourceMappingURL=5952438e0843fb8589a3b6a05756859bce523626.js.map