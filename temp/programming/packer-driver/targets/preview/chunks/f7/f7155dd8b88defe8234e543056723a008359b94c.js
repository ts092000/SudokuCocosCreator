      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec(_class = class GameController extends Component {
        ...
        createPuzzleBoard() {
          ...
          for (var row = 0; row < boardSize; row++) {
            var rowValues = puzzleGame.slice(row * boardSize, (row + 1) * boardSize);
            var rowSprites = [];
            ...
            for (var col = 0; col < boardSize; col++) {
              ...
              label.node.setPosition(col * 60 + 30, row * 60 + 30);
...
//# sourceMappingURL=f7155dd8b88defe8234e543056723a008359b94c.js.map