        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop(i) {
            ...
            var _loop2 = function _loop2(j) {
                    ...
                    for (var _i3 = 0; _i3 < 9; _i3++) {
                      if (_i3 !== row) {
                        ...
                        if (_this3.frameNodeArray.length > _this3.frameNodeArrayLength + 20) {
                          for (var _i4 = _this3.frameNodeArray.length - 20; _i4 < _this3.frameNodeArray.length; _i4++) {
                    ...
                    for (var _i6 = rowStart; _i6 < rowStart + 3; _i6++) {
                      for (var _j2 = colStart; _j2 < colStart + 3; _j2++) {
                        if (_i6 !== row && _j2 !== col) {
                          ...
                          if (_this3.frameNodeArray.length > _this3.frameNodeArrayLength + 20) {
                            for (var _i7 = _this3.frameNodeArray.length - 20; _i7 < _this3.frameNodeArray.length; _i7++) {
                              _this3.frameNodeArrayLength++;
                              console.log(_this3.frameNodeArrayLength);
                              console.log(_this3.frameNodeArray.length);
              ...
              nodeNum.parent = _this3.bgNodeValue;
              ...
              nodeNum.on(Node.EventType.TOUCH_END, () => {
                if (_this3.selectedNode) {
                  ...
                  if (!isNaN(selectedValue)) {
                    ...
                    console.log(nodeCheck[_i8][_j3].filled);
                    ...
                    } else if (nodeCheck[_i8][_j3].filled && isCorrect == false) {
                      console.log(isCorrect);
                      labelBlockSelect.color = Color.RED;
                      _this3.redNumber++;
                      _this3.gameView.PlayerFault.string = "L\u1ED7i: " + _this3.redNumber + "/3";
                    ...
                    } else if (nodeCheck[_i8][_j3].filled && isCorrect == true) {
                      console.log(isCorrect);
                      labelBlockSelect.color = Color.BLUE;
                      nodeCheck[_i8][_j3].filled = true;
                      console.log(emtyNode);
...
//# sourceMappingURL=2e9a40cddb172f74dbd20383eb351276587a77c7.js.map