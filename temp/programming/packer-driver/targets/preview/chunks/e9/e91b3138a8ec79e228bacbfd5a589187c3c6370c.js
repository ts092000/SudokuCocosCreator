                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (var _j = 0; _j < 9; _j++) {
                      if (_j !== col) {
                        ...
                        var frameNodeArray2 = _this3.frameNodeArray.splice(-20);

                        if (_this3.frameNodeArray.length > 20) {
                          for (var _i5 = 0; _i5 < 20; _i5++) {
                            frameNodeArray2[_i5].destroy();
                          } // this.frameNodeArray.length = 0;   
                    ...
                    for (var _i6 = rowStart; _i6 < rowStart + 3; _i6++) {
                      for (var _j2 = colStart; _j2 < colStart + 3; _j2++) {
                        if (_i6 !== row && _j2 !== col) {
                          ...
                          var frameNodeArray3 = _this3.frameNodeArray.splice(-20);

                          console.log(_this3.frameNodeArray);

                          if (_this3.frameNodeArray.length > 20) {
                            for (var _i7 = 0; _i7 < 20; _i7++) {
                              frameNodeArray3[_i7].destroy();
                            } // this.frameNodeArray.length = 0;   
...
//# sourceMappingURL=e91b3138a8ec79e228bacbfd5a589187c3c6370c.js.map