    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        start() {
          ...
          if (storedTimeBest) {
            this.timeBestArr = JSON.parse(storedTimeBest);
          }
        }
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  if (!isCorrect) {
                    ...
                    if (emtyNode === 0) {
                      ...
                      localStorage.setItem('timeMin', JSON.stringify(_this.timeBestArr));
...
//# sourceMappingURL=e98448620f284a123d38a4aa4dcbeb65a8ddb237.js.map