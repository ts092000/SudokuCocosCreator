          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (nodeSudoku.name !== "-" && _this.selectedNode) {
                  _this.selectedNode.getChildByName("labelBlock").getComponent(Label).string = "";
                }

                _this.selectedNode = nodeSudoku;
                nodeSudoku.getChildByName("labelBlock").getComponent(Label).string = "-";
              });
            };
...
//# sourceMappingURL=afff4f38ba4e51a6273d09ffad21854767614f91.js.map