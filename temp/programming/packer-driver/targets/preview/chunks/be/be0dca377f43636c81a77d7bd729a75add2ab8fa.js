                      ...
                      if (_i3 !== row) {
                        ...
                        if (_this3.frameNodeArray.length > 20) {
                          for (var _i4 = 1; _i4 <= 20; _i4++) {
                            ...
                            _this3.frameNodeArray[_i4 - 1].destroy(); // this.frameNodeArray = [];                                 
                      ...
                      if (_j !== col) {
                        ...
                        if (_this3.frameNodeArray.length > 20) {
                          for (var _i5 = 1; _i5 <= 20; _i5++) {
                            ...
                            _this3.frameNodeArray[_i5 - 1].destroy(); // this.frameNodeArray = [];                                 
                        ...
                        if (_i6 !== row && _j2 !== col) {
                          ...
                          if (_this3.frameNodeArray.length > 20) {
                            for (var _i7 = 1; _i7 <= 20; _i7++) {
                              ...
                              _this3.frameNodeArray[_i7 - 1].destroy(); // this.frameNodeArray = [];               
...
//# sourceMappingURL=be0dca377f43636c81a77d7bd729a75add2ab8fa.js.map