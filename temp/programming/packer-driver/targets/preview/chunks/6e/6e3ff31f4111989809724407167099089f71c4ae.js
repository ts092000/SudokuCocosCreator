System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, VerticalTextAlignment, Label, Vec3, Color, Sprite, Button, director, AudioClip, AudioSource, Slider, SudokuCreator, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _crd, ccclass, property, GameController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Button), _dec10 = property(Button), _dec11 = property(Label), _dec12 = property(Sprite), _dec13 = property(AudioClip), _dec14 = property(AudioClip), _dec15 = property(Sprite), _dec16 = property(Slider), _dec17 = property(Label), _dec18 = property(Label), _dec19 = property(Node), _dec20 = property(Label), _dec(_class = (_class2 = class GameController extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "settingVolumeBg", _descriptor15, this);
        ...
        start() {
          var storedTimeBest = localStorage.getItem('timeBestArr');
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  if (!isCorrect) {
                    ...
                    if (emtyNode === 0) {
                      ...
                      localStorage.setItem('scores', JSON.stringify(_this.timeBestArr));
                      var bestTime = Math.max(..._this.timeBestArr);
                      console.log(bestTime);
                      _this.bestTime.string = 'best Time: ' + bestTime;
        ...
        writable: true,
        initializer: null
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "settingVolumeBg", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=6e3ff31f4111989809724407167099089f71c4ae.js.map