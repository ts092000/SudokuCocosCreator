  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Button), _dec10 = property(Label), _dec11 = property(Sprite), _dec12 = property(AudioClip), _dec13 = property(AudioClip), _dec14 = property(Sprite), _dec15 = property(Slider), _dec16 = property(Label), _dec17 = property(Label), _dec(_class = (_class2 = class GameController extends Component {
        ...
        checkConflict(value, row, column) {
          var puzzle = this.puzzleGame; // Kiểm tra xem giá trị đã được chọn có trùng với các giá trị trong cùng hàng
          ...
          for (var _i = rowStart; _i < rowStart + 3; _i++) {
            for (var _j = colStart; _j < colStart + 3; _j++) {
              if (puzzle[_i * 9 + _j] === value) {
                return true;
              }
            }
          }
        ...
        createPuzzleBoard() {
          ...
          for (var _i2 = 0; _i2 < boardData.solution.length; _i2++) {
            this.solutionGame.push(boardData.solution[_i2] + 1);
          }

          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              var value = _this.puzzleGame[_i3 * 9 + j];
              var nodeSudoku = new Node("ValueGame");
              nodeSudoku.setPosition(_i3 * 55, j * 55);
            ...
            nodeNum.on(Node.EventType.TOUCH_END, () => {
              if (_this.selectedNode) {
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  var isCorrect = selectedValue === solutionValue && !_this.checkConflict(selectedValue, _i4, _j2);
...
//# sourceMappingURL=ff390b0ae5f05554ad596383893f9435293d234c.js.map