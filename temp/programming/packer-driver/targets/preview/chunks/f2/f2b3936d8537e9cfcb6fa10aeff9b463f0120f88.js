              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    console.log(_this2.frameNodeNumArray[_this2.frameNodeNumArray.length - 1]); // if(this.nodePositionArray[this.nodePositionArray.length - 2] != prefabInstance.position) {
                    //     console.log('1');
...
//# sourceMappingURL=f2b3936d8537e9cfcb6fa10aeff9b463f0120f88.js.map