    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        start() {
          ...
          if (bestscore) {
            var parsedBestScore = JSON.parse(bestscore);

            for (var i = 0; i < 3 && i < parsedBestScore.length; i++) {
        ...
        easyLevelGame() {
          ...
          // Lấy thời gian ngắn nhất cho mức độ chơi này
          var bestTime = this.timeBestArr[0]; // Tạo bảng sudoku và chơi game
          ...
          this.bgNodeValue.node.active = true;
          this.schedule(this.updateTimer, 1);
          this.levelLabel.string = "Độ khó : DỄ"; // Kiểm tra thời gian hoàn thành và cập nhật thời gian ngắn nhất

          this.onComplete = function () {
            var timeElapsed = this.timeElapsed;

            if (timeElapsed < bestTime) {
              this.timeBestArr[0] = timeElapsed;
        ...
        mediumLevelGame() {
          ...
          // Lấy thời gian ngắn nhất cho mức độ chơi này
          var bestTime = this.timeBestArr[1]; // Tạo bảng sudoku và chơi game
          ...
          this.bgNodeValue.node.active = true;
          this.schedule(this.updateTimer, 1);
          this.levelLabel.string = "Độ khó : TRUNG BÌNH"; // Kiểm tra thời gian hoàn thành và cập nhật thời gian ngắn nhất

          this.onComplete = function () {
            var timeElapsed = this.timeElapsed;

            if (timeElapsed < bestTime) {
              this.timeBestArr[1] = timeElapsed;
              localStorage.setItem('bestTime', JSON.stringify(this.timeBestArr));
            }
          };
        }
        ...
        hardLevelGame() {
          ...
          // Lấy thời gian ngắn nhất cho mức độ chơi này
          var bestTime = this.timeBestArr[2]; // Tạo bảng sudoku và chơi game
          ...
          this.bgNodeValue.node.active = true;
          this.schedule(this.updateTimer, 1);
          this.levelLabel.string = "Độ khó : KHÓ"; // Kiểm tra thời gian hoàn thành và cập nhật thời gian ngắn nhất

          this.onComplete = function () {
            var timeElapsed = this.timeElapsed;

            if (timeElapsed < bestTime) {
              this.timeBestArr[2] = timeElapsed;
              localStorage.setItem('bestTime', JSON.stringify(this.timeBestArr));
            }
          };
        }
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  if (!isCorrect) {
                    ...
                    if (_this.redNumber === 4) {
                      ...
                      localStorage.setItem('bestTime', JSON.stringify(_this.timeBestArr[_i3]));
...
//# sourceMappingURL=3723e442a1dea7126a2a2294b307757fdf9cc8bb.js.map