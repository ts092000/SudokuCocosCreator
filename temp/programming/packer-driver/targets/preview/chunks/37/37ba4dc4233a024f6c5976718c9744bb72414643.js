System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, VerticalTextAlignment, Label, Vec3, Color, director, Prefab, instantiate, find, SudokuCreator, GameView, StoredPersistNode, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, GameController;
                  ...
                  if (!nodeCheck[_i3][_j].filled) {
                    if (isCorrect == true) {
                      ...
                      if (emtyNode === 0) {
                        ...
                        _this3.gameView.WinAudio.play(); // this.gameView.BgMain.getComponent(AudioSource).pause();      
                      ...
                      if (_this3.redNumber == 4) {
                        ...
                        _this3.gameView.LoseAudio.play(); // this.gameView.BgMain.getComponent(AudioSource).pause();
...
//# sourceMappingURL=37ba4dc4233a024f6c5976718c9744bb72414643.js.map