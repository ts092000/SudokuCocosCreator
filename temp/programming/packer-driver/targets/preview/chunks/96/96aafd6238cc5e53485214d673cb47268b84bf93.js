    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        rePlayGame() {
          ...
          this.gameView.StartGame.node.active = false;
        }
        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              var emptyString = "    "; // Khoảng trắng có độ dài bằng 4 ký tự

              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (_this.selectedNode) {
                    var prevLabelBlock = _this.selectedNode.getComponent(Label);

                    var prevValue = prevLabelBlock.string.trim();
                    prevLabelBlock.string = prevValue === emptyString ? "aaa" : prevValue;
                  }

                  _this.selectedNode = nodeSudoku;
                  labelBlock.string = "-";
                } else {
                  if (_this.selectedNode && _this.selectedNode !== nodeSudoku) {
                    var _prevLabelBlock = _this.selectedNode.getComponent(Label);

                    var _prevValue = _prevLabelBlock.string.trim();

                    _prevLabelBlock.string = _prevValue === emptyString ? "aaa" : _prevValue;
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  if (!isCorrect) {
                    ...
                    if (_this.redNumber === 4) {
                      ...
                      console.log(bestTime);
                      _this.bestTime.string = 'best Time: ' + bestTime + 'giây';
                    }
                  } else {
                    labelBlock.color = Color.BLUE;
                    emtyNode -= 1;
                    ...
                    if (emtyNode === 0) {
                      ...
                      _this.bestTime.string = 'best Time: ' + _bestTime + 'giây';
...
//# sourceMappingURL=96aafd6238cc5e53485214d673cb47268b84bf93.js.map