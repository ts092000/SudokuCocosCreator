        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (parameters === null) {
              ...
              gameClientParams.volumeAudio = _this.View.AudioBg.volume;
            ...
            var volumeValue = localStorage.getItem('volumeSudokuArray');
            localStorage.setItem('volumeSudokuArray', JSON.stringify(_this.volumeSudokuArray));

            if (volumeValue) {
              _this.volumeSudokuArray = JSON.parse(volumeValue);
              localStorage.setItem('volumeSudokuArray', JSON.stringify(_this.volumeSudokuArray));
            }

            if (_this.volumeSudokuArray.length == 0) {
              _this.View.AudioBg.volume = 0.7;

              _this.volumeSudokuArray.push(_this.View.AudioBg.volume);
            } else {
              _this.View.AudioBg.volume = _this.volumeSudokuArray[_this.volumeSudokuArray.length - 1];
            }

            if (_this.View.AudioBg.volume == 0.7) {
              _this.View.AudioMute.node.active = false;
              _this.View.AudioUnmute.node.active = true;
            }

            if (_this.View.AudioBg.volume == 0) {
              _this.View.AudioMute.node.active = true;
              _this.View.AudioUnmute.node.active = false;
            }
          })();
        }
...
//# sourceMappingURL=d0f21b685f1187e4a18c8f58dfa8f04aa17d5e2c.js.map