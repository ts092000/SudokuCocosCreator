                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (var _i3 = 0; _i3 < 9; _i3++) {
                      if (_i3 !== row) {
                        ...
                        console.log(_this3.frameNodeArray); // if (this.frameNodeArray.length > 20) {
                        //     for (let i = 1; i <= 20; i++) {
                        //         console.log(this.frameNodeArray[i-1]);
                    ...
                    for (var _i6 = rowStart; _i6 < rowStart + 3; _i6++) {
                      for (var _j2 = colStart; _j2 < colStart + 3; _j2++) {
                        if (_i6 !== row && _j2 !== col) {
                          ...
                          _this3.frameNodeArray = []; // if (this.frameNodeArray.length > 20) {
                          // }
...
//# sourceMappingURL=0025036adbc1c7ee416cad25c79aeb7fd4b9528b.js.map