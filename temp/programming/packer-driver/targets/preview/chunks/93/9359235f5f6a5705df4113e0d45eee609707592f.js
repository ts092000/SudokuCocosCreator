          ...
          var _loop = function _loop(i) {
            ...
            var _loop2 = function _loop2(j) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (prevSelectedNode) {
                    // remove frameNodes of the previous selected node
                    removeFrameNodes(prevSelectedNode);
                  }

                  prevSelectedNode = nodeSudoku; // set the selected node
              ...
              }); // function to remove frameNodes of a given node

              function removeFrameNodes(node) {
                node.parent.children.forEach(child => {
                  if (child.name.startsWith('frameNode')) {
                    child.destroy();
                  }
                });
              }
...
//# sourceMappingURL=9359235f5f6a5705df4113e0d45eee609707592f.js.map