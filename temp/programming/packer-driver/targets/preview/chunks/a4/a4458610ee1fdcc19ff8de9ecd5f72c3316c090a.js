        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop(i) {
            ...
            var _loop2 = function _loop2(j) {
                ...
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    var _loop4 = function _loop4() {
                      if (_j !== col) {
                        var node = _this3.gameView.BoardNode.getChildByName("ValueGame" + (i * 9 + _j));
                    ...
                    for (var _i4 = rowStart; _i4 < rowStart + 3; _i4++) {
                      var _loop5 = function _loop5() {
                        if (_i4 !== row && _j2 !== col) {
                          var node = _this3.gameView.BoardNode.getChildByName("ValueGame" + (_i4 * 9 + _j2));
              ...
              nodeNum.parent = _this3.bgNodeValue.node;
...
//# sourceMappingURL=a4458610ee1fdcc19ff8de9ecd5f72c3316c090a.js.map