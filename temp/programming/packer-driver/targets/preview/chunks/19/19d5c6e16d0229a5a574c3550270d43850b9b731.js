        ...
        createPuzzleBoard() {
          ...
          for (var _i2 = 0; _i2 < 9; _i2++) {
            ...
            var _loop = function _loop() {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (selectedNode && nodeState[selectedNode.name]) {
                    var oldPrefab = selectedNode.getChildByName('prefabInstance');

                    if (oldPrefab) {
                      oldPrefab.removeFromParent();
                      delete nodeState[selectedNode.name];
                    }
                  }

                  selectedNode = nodeSudoku;
...
//# sourceMappingURL=19d5c6e16d0229a5a574c3550270d43850b9b731.js.map