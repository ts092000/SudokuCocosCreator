          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  _this.selectedNode = nodeSudoku; // const prefabInstance = instantiate(this.frameNode);
                  // prefabInstance.setPosition(nodeSudoku.position);
                  // nodeSudoku.parent.addChild(prefabInstance);

                  setTimeout(() => {
                    if (_this.selectedNode === nodeSudoku) {
...
//# sourceMappingURL=870223016b1c998137c3beba7fe52c33403ae472.js.map