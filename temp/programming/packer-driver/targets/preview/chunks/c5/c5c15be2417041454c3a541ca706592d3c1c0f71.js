        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop(i) {
            ...
            var _loop2 = function _loop2(j) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  var prevSelectedNode = _this.selectedNode;
                  nodeSudoku.parent.removeAllChildren();
              ...
              nodeNum.on(Node.EventType.TOUCH_END, () => {
                if (_this.selectedNode) {
                  ...
                  if (!isNaN(selectedValue)) {
                    ...
                    var _i5 = Math.floor(_this.selectedNode.position.x / 55);

                    var _j3 = Math.floor(_this.selectedNode.position.y / 55);
...
//# sourceMappingURL=c5c15be2417041454c3a541ca706592d3c1c0f71.js.map