              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    _this2.nodePositionArray.push(prefabInstance.position);

                    _this2.frameNodeNumArray.push(prefabInstance);

                    console.log(_this2.nodePositionArray[_this2.nodePositionArray.length - 2]);
                    console.log(_this2.frameNodeNumArray[_this2.frameNodeNumArray.length - 1]);

                    if (_this2.nodePositionArray[_this2.nodePositionArray.length - 2] != prefabInstance.position) {
                      console.log('1');

                      _this2.frameNodeNumArray[_this2.frameNodeNumArray.length - 1].destroy();
                    }
...
//# sourceMappingURL=e47be1050b1e4f816fda502758500b1d61625c7f.js.map