        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (selectedNodeName && selectedNodeName !== nodeSudoku.name) {
                    var prevSelectedNode = nodeSudoku.parent.getChildByName(selectedNodeName);
                    var prefabInstance = prevSelectedNode.getChildByName("prefabInstance");

                    if (prefabInstance) {
                      prevSelectedNode.removeChild(prefabInstance);
                    }
                  }

                  selectedNodeName = nodeSudoku.name;
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    _prefabInstance.name = "prefabInstance";
...
//# sourceMappingURL=53d02f736718c3bb092549bff748ecf2cb79116a.js.map