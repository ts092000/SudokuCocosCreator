        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop(i) {
            ...
            var _loop2 = function _loop2(j) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    var prefabInstance = instantiate(_this.frameNodeNum);
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (prevSelectedNode && prevSelectedNode !== nodeSudoku) {
                    // remove all prefabs related to the previously selected node
                    for (var _i5 = 0; _i5 < 81; _i5++) {
                      var node = _this.boardNode.getChildByName("ValueGame" + _i5);

                      node.parent.removeAllChildren();
                    }
                  }

                  prevSelectedNode = nodeSudoku;
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (var _i6 = 0; _i6 < 9; _i6++) {
                      if (_i6 !== row) {
                        var _node3 = _this.boardNode.getChildByName("ValueGame" + (_i6 * 9 + j));

                        var nodePrefab = instantiate(_this.frameNode);
                        nodePrefab.setPosition(_node3.position);

                        _node3.parent.addChild(nodePrefab);
                      }
                    }
                    ...
                    for (var _j3 = 0; _j3 < 9; _j3++) {
                      if (_j3 !== col) {
                        var _node4 = _this.boardNode.getChildByName("ValueGame" + (i * 9 + _j3));

                        var _nodePrefab3 = instantiate(_this.frameNode);

                        _nodePrefab3.setPosition(_node4.position);

                        _node4.parent.addChild(_nodePrefab3);
                      }
                    }
                    ...
                    for (var _i7 = rowStart; _i7 < rowStart + 3; _i7++) {
                      for (var _j4 = colStart; _j4 < colStart + 3; _j4++) {
                        if (_i7 !== row && _j4 !== col) {
                          var _node5 = _this.boardNode.getChildByName("ValueGame" + (_i7 * 9 + _j4));

                          var _nodePrefab4 = instantiate(_this.frameNode);

                          _nodePrefab4.setPosition(_node5.position);

                          _node5.parent.addChild(_nodePrefab4);
                        }
                      }
                    }
                  }
              ...
              nodeNum.on(Node.EventType.TOUCH_END, () => {
                if (_this.selectedNode) {
                  ...
                  if (!isNaN(selectedValue)) {
                    ...
                    var _i8 = Math.floor(_this.selectedNode.position.x / 55);

                    var _j5 = Math.floor(_this.selectedNode.position.y / 55);

                    var position = _i8 * 9 + _j5;
                    ...
                    if (!nodeCheck[_i8][_j5].filled) {
                      if (isCorrect) {
                        labelBlockSelect.color = Color.BLUE;
                        emtyNode--;
                        nodeCheck[_i8][_j5].filled = true;
                        console.log(emtyNode);
...
//# sourceMappingURL=531f7ddc851c5b78e9f5099f1abcbcafebbad07d.js.map