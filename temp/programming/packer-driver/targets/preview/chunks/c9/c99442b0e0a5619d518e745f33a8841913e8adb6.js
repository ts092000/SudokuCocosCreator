              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (selectedNode !== null && selectedNode !== nodeSudoku) {
                    ...
                    var oldPrefabInstance = selectedNode.getChildByName("frameNode"); // Lấy prefabInstance của node cũ
                  ...
                  prefabInstance.setPosition(nodeSudoku.position);
                  prefabInstance.name = "frameNode)"; // Đặt tên cho prefabInstance để dễ dàng tìm kiếm và xóa sau này
...
//# sourceMappingURL=c99442b0e0a5619d518e745f33a8841913e8adb6.js.map