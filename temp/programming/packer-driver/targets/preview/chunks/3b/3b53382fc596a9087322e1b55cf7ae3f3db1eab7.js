            ...
            var _loop = function _loop() {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    prefabInstance.setPosition(nodeSudoku.getPosition());
                    nodeSudoku.getParent().addChild(prefabInstance);
                  } else {
                    prefabInstance.setPosition(nodeSudoku.getPosition());
                  }
                }
              ...
              nodeSudoku.on(Node.EventType.TOUCH_MOVE, event => {
                if (value === 0 && prefabInstance) {
                  ...
                  var newPos = nodeSudoku.getParent().convertToNodeSpaceAR(touchPos);
                  prefabInstance.setPosition(newPos);
                }
              });
...
//# sourceMappingURL=3b53382fc596a9087322e1b55cf7ae3f3db1eab7.js.map