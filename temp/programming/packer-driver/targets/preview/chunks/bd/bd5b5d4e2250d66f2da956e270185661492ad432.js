System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, VerticalTextAlignment, Label, Vec3, Color, Sprite, Button, director, AudioClip, AudioSource, Slider, SudokuCreator, GameView, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _descriptor21, _descriptor22, _descriptor23, _descriptor24, _descriptor25, _crd, ccclass, property, GameController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'VerticalTextAlignment', 'Label', 'Vec3', 'Color', 'Sprite', 'Button', 'director', 'AudioClip', 'AudioSource', 'Slider', 'Graphics', 'SpriteFrame', 'loader']);
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        easyLevelGame() {
          ...
          this.levelPanel.active = false; // this.bgNodeValue.node.active = true;
        ...
        createPuzzleBoard() {
          ...
          for (var _i2 = 0; _i2 < 9; _i2++) {
            for (var j = 0; j < 9; j++) {
              var frameNode = new Node("Frame");
              frameNode.setPosition(_i2 * 55, j * 55);
              this.boardEffectNode.addChild(frameNode);
              var blackNode = new Node("Black");
              blackNode.setPosition(0, 0); // blackNode.setContentSize(50, 50);

              blackNode.setOpacity(128); // Set the opacity to 50%

              frameNode.addChild(blackNode);
            }
          }

          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              var value = _this.puzzleGame[_i3 * 9 + _j];
              var nodeSudoku = new Node("ValueGame");
              nodeSudoku.setPosition(_i3 * 55, _j * 55);
            ...
            nodeNum.on(Node.EventType.TOUCH_END, () => {
              if (_this.selectedNode) {
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  var _i4 = Math.floor(_this.selectedNode.position.x / 55);

                  var _j2 = Math.floor(_this.selectedNode.position.y / 55);

                  var position = _i4 * 9 + _j2;
...
//# sourceMappingURL=bd5b5d4e2250d66f2da956e270185661492ad432.js.map