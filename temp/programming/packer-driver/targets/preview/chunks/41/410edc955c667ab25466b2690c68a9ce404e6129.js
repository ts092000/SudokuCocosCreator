          ...
          for (var _i2 = 0; _i2 < 9; _i2++) {
            ...
            var _loop = function _loop() {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  // Remove all existing prefabs before creating a new one
                  var existingPrefabs = nodeSudoku.parent.getComponentsInChildren(Prefab);

                  for (var prefab of existingPrefabs) {
                    if (prefab.name === 'FramePrefab') {
                      prefab.node.destroy();
                    }
                  }
...
//# sourceMappingURL=410edc955c667ab25466b2690c68a9ce404e6129.js.map