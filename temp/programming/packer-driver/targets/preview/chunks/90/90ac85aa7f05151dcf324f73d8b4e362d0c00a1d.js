              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    console.log(_this2.nodePositionArray);
                    console.log(_this2.frameNodeNumArray);

                    if (_this2.nodePositionArray[_this2.nodePositionArray.length - 2] != prefabInstance.position) {
                      console.log('1');
                      if (_this2.frameNodeNumArray.length > 1) _this2.frameNodeNumArray[_this2.frameNodeNumArray.length - 2].destroy();
                    }
...
//# sourceMappingURL=90ac85aa7f05151dcf324f73d8b4e362d0c00a1d.js.map