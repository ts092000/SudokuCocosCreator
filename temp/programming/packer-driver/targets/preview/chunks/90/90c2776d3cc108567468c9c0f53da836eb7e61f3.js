              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    nodeSudoku.parent.addChild(prefabInstance); // const row = Math.floor(nodeSudoku.position.x / 55);
                    // for (let i = 0; i < 9; i++) {
                    //     if (i !== row) {
...
//# sourceMappingURL=90c2776d3cc108567468c9c0f53da836eb7e61f3.js.map