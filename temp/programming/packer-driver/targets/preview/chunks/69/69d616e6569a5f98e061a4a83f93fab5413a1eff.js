System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, VerticalTextAlignment, Label, Vec3, Color, director, AudioClip, Prefab, instantiate, find, SudokuCreator, GameView, StoredPersistNode, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _crd, ccclass, property, GameController;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        type: Node
      }), _dec5 = property(AudioClip), _dec6 = property(AudioClip), _dec7 = property(AudioClip), _dec8 = property(AudioClip), _dec9 = property(AudioClip), _dec10 = property(Prefab), _dec11 = property(Prefab), _dec(_class = (_class2 = class GameController extends Component {
        constructor() {
          super(...arguments);
        ...
        start() {
          ...
          return _asyncToGenerator(function* () {
            ...
            console.log(gameClientParams.AudioBg); // let audioParam = audioNode.getComponent(StoredPersistNode);
            // console.log(audioParam);

            _this2.AudioBg = gameClientParams.AudioBg;
            console.log(_this2.AudioBg); // console.log(this.AudioBg);

            gameClientParams.AudioBg.play();
                      ...
                      if (_i4 !== row) {
                        ...
                        if (_this3.frameNodeArray.length > _this3.frameNodeArrayLength + 20) {
                          for (var _i5 = _this3.frameNodeArray.length - 20; _i5 < _this3.frameNodeArray.length; _i5++) {
                            ...
                            console.log(_this3.frameNodeArrayLength);
                            console.log(_this3.frameNodeArray.length);
                  ...
                  if (!nodeCheck[_i3][_j].filled) {
                    if (isCorrect == true) {
                      ...
                      if (emtyNode === 0) {
                        ...
                        _this3.volumeWinGame.play(); // this.gameView.BgMain.getComponent(AudioSource).pause();      
                      ...
                      if (_this3.redNumber == 4) {
                        ...
                        _this3.gameView.BgBoardNode.active = false;
                        ...
                        _this3.volumeLose.play(); // this.gameView.BgMain.getComponent(AudioSource).pause();
...
//# sourceMappingURL=69d616e6569a5f98e061a4a83f93fab5413a1eff.js.map