        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              var nodeState = {}; // nodeSudoku.on(Node.EventType.TOUCH_END, () => {
              //     if (value === 0) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    prefabInstance.setPosition(nodeSudoku.position);
                    nodeSudoku.parent.addChild(prefabInstance);
                    var prevSelectedNode = nodeState.__selectedNode__; // lấy node trước đó được chọn

                    if (prevSelectedNode) {
                      var prevPrefabInstance = nodeSudoku.parent.getChildByName(prevSelectedNode.name + "_prefab"); // tìm prefabInstance của node trước đó
...
//# sourceMappingURL=74e96715b28e026a3c81cb6df80fcf449daf0421.js.map