        ...
        createPuzzleBoard() {
          ...
          var _loop = function _loop() {
            var _loop2 = function _loop2() {
              ...
              var prevSelectedNode = null; // nodeSudoku.on(Node.EventType.TOUCH_END, () => {
              //     if (value === 0) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (prevSelectedNode) {
                    var prevLabelBlock = prevSelectedNode.getComponent(Label);

                    if (prevLabelBlock.string === "-") {
                      prevLabelBlock.string = "aaa";
                    }
                  }

                  prevSelectedNode = nodeSudoku;

                  var _labelBlock = nodeSudoku.getComponent(Label);
...
//# sourceMappingURL=74e4abc7e3a3f4fba9d0e04cdc8138866221445d.js.map