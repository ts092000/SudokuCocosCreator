                      ...
                      if (_i3 !== row) {
                        ...
                        if (_this3.frameNodeArray.length > 20) {
                          for (var _i4 = 0; _i4 < 20; _i4++) {
                            ...
                            _this3.frameNodeArray.splice(_i4);
                          }
                      ...
                      if (_j !== col) {
                        ...
                        if (_this3.frameNodeArray.length > 20) {
                          for (var _i5 = 0; _i5 < 20; _i5++) {
                            ...
                            _this3.frameNodeArray.splice(_i5);
                          }
                        } // if (this.frameNodeArray.length > 20) {
                        // }
                        // this.frameNodeArray = [];                                 
                        ...
                        if (_i6 !== row && _j2 !== col) {
                          ...
                          if (_this3.frameNodeArray.length > 20) {
                            for (var _i7 = 0; _i7 < 20; _i7++) {
                              ...
                              _this3.frameNodeArray.splice(_i7);
                            }
                          } // if (this.frameNodeArray.length > 20) {
                          //     // this.frameNodeArray.length = 0;   
                          // }
...
//# sourceMappingURL=f34aac184966360fecadb91c178f77e88498d9b4.js.map