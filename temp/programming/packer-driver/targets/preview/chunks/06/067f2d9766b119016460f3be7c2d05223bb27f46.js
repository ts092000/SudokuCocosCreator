    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        start() {
          ...
          if (bestscore1) {
            this.timeBestArr = JSON.parse(bestscore1);
            this.bestTime.string = 'Thời gian nhanh nhất: ' + Math.min(...this.timeBestArr);
          }
          ...
          if (bestscore2) {
            this.timeBestArr = JSON.parse(bestscore2);
            this.bestTime.string = 'Thời gian nhanh nhất: ' + Math.min(...this.timeBestArr);
                  ...
                  if (!isCorrect) {
                    ...
                    if (_this.redNumber == 4) {
                      ...
                      if (_this.difficultyLevel === 0.2) {
                        ...
                        localStorage.setItem('bestTime1', JSON.stringify(_this.timeBestArr));
                        _this.winGame.active = true;
                      }
                      ...
                      if (_this.difficultyLevel === 0.3) {
                        ...
                        localStorage.setItem('bestTime2', JSON.stringify(_this.timeBestArr));
                        _this.winGame.active = true;
                      }
                    }
                  } else {
...
//# sourceMappingURL=067f2d9766b119016460f3be7c2d05223bb27f46.js.map