              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    console.log(_this2.nodePositionArray[_this2.nodePositionArray.length - 1]);
                    console.log(prefabInstance.position);

                    if (_this2.nodePositionArray[_this2.nodePositionArray.length - 1] != prefabInstance.position) {
                      console.log('1');
...
//# sourceMappingURL=0781da1bef016e0e11a954ae44118fc0fb3cc15c.js.map