              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (_this.selectedNode && _this.selectedNode !== nodeSudoku) {
                    // Khôi phục giá trị ban đầu của ô đã chọn trước đó
                    var prevLabelBlock = _this.selectedNode.getComponent(Label);

                    prevLabelBlock.string = prevValue.toString();
                  }
...
//# sourceMappingURL=01c783f2037df6fbcc1e7d13e4b92762ca3b789f.js.map