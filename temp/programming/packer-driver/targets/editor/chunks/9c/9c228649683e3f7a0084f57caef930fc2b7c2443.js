              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (selectedNodeName && selectedNodeName !== nodeSudoku.name) {
                    ...
                    if (prevSelectedNode && prevSelectedNode.childrenCount > 0) {
                      prevSelectedNode.removeChild(prevSelectedNode.children[0]);
                    }
                  }
...
//# sourceMappingURL=9c228649683e3f7a0084f57caef930fc2b7c2443.js.map