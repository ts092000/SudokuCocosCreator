                ...
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    if (this.nodePositionArray[this.nodePositionArray.length - 2] != prefabInstance.position) {
                      console.log('1');
                      if (this.frameNodeNumArray.length > 1) this.frameNodeNumArray[this.frameNodeNumArray.length - 2].destroy();
                    }
...
//# sourceMappingURL=0f20b97099229b4bd793121bf413e3b3abf1ad68.js.map