        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              let prevSelectedNode = null; // nodeSudoku.on(Node.EventType.TOUCH_END, () => {
              //     if (value === 0) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (prevSelectedNode) {
                    const prevLabelBlock = prevSelectedNode.getComponent(Label);
                  ...
                  const labelBlock = nodeSudoku.getComponent(Label);
                  labelBlock.string = "-";
                }
              });
            }
...
//# sourceMappingURL=078d4dd08ac832896e4124fb30e14550facb04a1.js.map