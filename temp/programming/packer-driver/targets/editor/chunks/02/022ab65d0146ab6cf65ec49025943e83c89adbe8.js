    ...
    execute: function () {
      ...
      _export("StoredPersistNode", StoredPersistNode = (_dec = ccclass('StoredPersistNode'), _dec(_class = class StoredPersistNode extends Component {
        ...
        async start() {
          ...
          console.log(this.volumeAudio); // this.gameClient = new GameClient("643fc5fe0a3bf6132391328d", "568a590d-f9d1-4a10-b59d-ea6e0d9e9786");
        }
...
//# sourceMappingURL=022ab65d0146ab6cf65ec49025943e83c89adbe8.js.map