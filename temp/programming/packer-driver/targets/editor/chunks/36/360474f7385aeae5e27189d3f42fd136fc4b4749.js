                    ...
                    for (let i = 0; i < 9; i++) {
                      if (i !== row) {
                        ...
                        if (this.frameNodeArray.length > 20) {
                          for (let i = 0; i < this.frameNodeArray.length - 1; i++) {
                        ...
                        } else if (this.frameNodeArray.length == 21) {
                          this.frameNodeArray.splice(-21);
                        }
                      }
                    }
...
//# sourceMappingURL=360474f7385aeae5e27189d3f42fd136fc4b4749.js.map