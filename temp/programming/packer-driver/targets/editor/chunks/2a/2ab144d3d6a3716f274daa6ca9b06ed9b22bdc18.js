        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            ...
            for (let j = 0; j < 9; j++) {
              ...
              let currentPrefabInstance = null; // Khởi tạo biến toàn cục để lưu trữ prefab hiện tại
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  this.node.addChild(currentPrefabInstance); // Cập nhật vị trí của prefab theo vị trí của node được chọn
...
//# sourceMappingURL=2ab144d3d6a3716f274daa6ca9b06ed9b22bdc18.js.map