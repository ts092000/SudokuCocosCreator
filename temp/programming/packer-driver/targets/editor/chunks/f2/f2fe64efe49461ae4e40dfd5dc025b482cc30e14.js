  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        error: Error()
      }), GameView) : GameView), _dec3 = property({
        type: Label
      }), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Button), _dec10 = property(Button), _dec11 = property(Label), _dec12 = property(Sprite), _dec13 = property(AudioClip), _dec14 = property(AudioClip), _dec15 = property(AudioClip), _dec16 = property(AudioClip), _dec17 = property(Sprite), _dec18 = property(Label), _dec19 = property(Label), _dec20 = property(Node), _dec21 = property(Label), _dec22 = property(Label), _dec23 = property(Prefab), _dec24 = property(Prefab), _dec(_class = (_class2 = class GameController extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "newGame", _descriptor6, this);
          ...
          _initializerDefineProperty(this, "bestTimeLevle", _descriptor21, this);

          _initializerDefineProperty(this, "frameNode", _descriptor22, this);

          _initializerDefineProperty(this, "frameNodeNum", _descriptor23, this);
        ...
        writable: true,
        initializer: null
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "newGame", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
        ...
        writable: true,
        initializer: null
      }), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, "bestTimeLevle", [_dec22], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor22 = _applyDecoratedDescriptor(_class2.prototype, "frameNode", [_dec23], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor23 = _applyDecoratedDescriptor(_class2.prototype, "frameNodeNum", [_dec24], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=f2fe64efe49461ae4e40dfd5dc025b482cc30e14.js.map