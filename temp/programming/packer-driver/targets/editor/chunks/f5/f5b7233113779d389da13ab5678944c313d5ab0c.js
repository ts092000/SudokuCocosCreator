        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              this.boardNode.addChild(nodeSudoku); // const frameNode = new Node("Frame");
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  console.log(emtyNode);
                  const graphics = nodeSudoku.addComponent(Graphics);
...
//# sourceMappingURL=f5b7233113779d389da13ab5678944c313d5ab0c.js.map