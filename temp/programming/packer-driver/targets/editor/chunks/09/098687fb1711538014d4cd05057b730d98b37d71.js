            ...
            for (let j = 0; j < 9; j++) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  const existingPrefabs = nodeSudoku.parent.getComponentsInChildren(Prefab);

                  for (const prefab of existingPrefabs) {
...
//# sourceMappingURL=098687fb1711538014d4cd05057b730d98b37d71.js.map