    ...
    execute: function () {
      ...
      _export("StoredPersistNode", StoredPersistNode = (_dec = ccclass('StoredPersistNode'), _dec(_class = class StoredPersistNode extends Component {
        ...
        async start() {
          ...
          this.AudioBg.play(); // this.gameClient = new GameClient("643fc5fe0a3bf6132391328d", "568a590d-f9d1-4a10-b59d-ea6e0d9e9786");
        }
...
//# sourceMappingURL=c2fd911f68bc5c5e19612f86b428c10f41273be7.js.map