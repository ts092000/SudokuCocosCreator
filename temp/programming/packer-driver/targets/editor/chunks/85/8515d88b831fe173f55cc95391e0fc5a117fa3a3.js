              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  if (selectedNodeName && selectedNodeName !== nodeSudoku.name) {
                    const prevSelectedNode = nodeSudoku.parent.getChildByName(selectedNodeName);
                    const prefabInstance = prevSelectedNode.getChildByName("prefabInstance");
...
//# sourceMappingURL=8515d88b831fe173f55cc95391e0fc5a117fa3a3.js.map