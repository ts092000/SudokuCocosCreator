  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        easyLevelGame() {
          this.difficultyLevel = 0.2; // this.gameView.StartAudio.play();
        ...
        mediumLevelGame() {
          this.difficultyLevel = 0.5; // this.gameView.StartAudio.play();
        ...
        hardLevelGame() {
          this.difficultyLevel = 0.8; // this.gameView.StartAudio.play();
...
//# sourceMappingURL=10b258d76582ac9d17de66244c9ed202c19dace4.js.map