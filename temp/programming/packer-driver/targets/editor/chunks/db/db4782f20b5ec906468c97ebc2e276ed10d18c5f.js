System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Button), _dec10 = property(Label), _dec(_class = (_class2 = class GameController extends Component {
        constructor(...args) {
          super(...args);
        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              labelBlock.string = value === 0 ? "    " : value.toString(); // nodeSudoku.on(Node.EventType.TOUCH_END, () => {
              //     this.selectedNode = nodeSudoku;
              //     labelBlock.string = "-";
              // });

              let previousLabel = null; // Biến trạng thái trước đó

              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                // Đặt labelBlock hiện tại thành "-"
                labelBlock.string = "-"; // Nếu đã có labelBlock trước đó, đặt lại thành "aaa"

                if (previousLabel) {
                  previousLabel.string = "aaa";
                } // Lưu labelBlock hiện tại vào biến trạng thái trước đó
...
//# sourceMappingURL=db4782f20b5ec906468c97ebc2e276ed10d18c5f.js.map