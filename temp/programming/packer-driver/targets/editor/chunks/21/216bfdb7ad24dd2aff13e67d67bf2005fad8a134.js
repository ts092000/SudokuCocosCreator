      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            ...
            labelValue.color = Color.BLACK; // let numberValue = find("NumberValueLabel");
                  ...
                  if (!nodeCheck[i][j].filled) {
                    if (isCorrect == true) {
                      ...
                      if (this.redNumber == 4) {
                        ...
                        nodeNumStore.active = false; // this.gameView.BgMain.getComponent(AudioSource).pause();
...
//# sourceMappingURL=216bfdb7ad24dd2aff13e67d67bf2005fad8a134.js.map