              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    const prefabInstance = nodeSudoku.parent.getChildByName(nodeSudoku.name);
                    ...
                    if (prefabInstance) {
                      ...
                      nodeState[nodeSudoku.name] = true;
                      const newPrefabInstance = instantiate(this.frameNode);
...
//# sourceMappingURL=67128d2542d475a325a745ecacea3651bba2aac5.js.map