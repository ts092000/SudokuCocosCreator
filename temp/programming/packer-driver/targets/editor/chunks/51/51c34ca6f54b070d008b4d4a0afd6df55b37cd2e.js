          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                ...
                const rowIndex = Math.floor(this.selectedNode.position.y);
                const colIndex = Math.floor(this.selectedNode.position.x);
...
//# sourceMappingURL=51c34ca6f54b070d008b4d4a0afd6df55b37cd2e.js.map