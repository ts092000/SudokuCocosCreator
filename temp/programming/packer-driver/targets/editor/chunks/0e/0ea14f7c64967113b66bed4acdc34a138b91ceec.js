                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (let i = 0; i < 9; i++) {
                      if (i !== row) {
                        ...
                        this.frameNodeArray1.push(nodePrefab);
                        console.log(this.frameNodeArray1);

                        if (this.frameNodeArray1.length > 20) {
                          for (let i = 0; i < 20; i++) {
                            this.frameNodeArray1[i].destroy();
                          }
                        }

                        if (this.frameNodeArray1.length > 20) {
                          this.frameNodeArray1.splice(-20);
                    ...
                    for (let j = 0; j < 9; j++) {
                      if (j !== col) {
                        ...
                        nodePrefab.setPosition(node.position);
                        node.parent.addChild(nodePrefab);
                        this.frameNodeArray2.push(nodePrefab);
                        console.log(this.frameNodeArray2);

                        if (this.frameNodeArray2.length > 20) {
                          for (let i = 0; i < 20; i++) {
                            this.frameNodeArray2[i].destroy();
                          }
                        }

                        if (this.frameNodeArray2.length > 20) {
                          this.frameNodeArray2.splice(-20);
                    ...
                    for (let i = rowStart; i < rowStart + 3; i++) {
                      for (let j = colStart; j < colStart + 3; j++) {
                        if (i !== row && j !== col) {
                          ...
                          nodePrefab.setPosition(node.position);
                          node.parent.addChild(nodePrefab);
                          this.frameNodeArray3.push(nodePrefab);
                          console.log(this.frameNodeArray3);

                          if (this.frameNodeArray3.length > 20) {
                            for (let i = 0; i < 20; i++) {
                              this.frameNodeArray3[i].destroy();
                            }
                          }

                          if (this.frameNodeArray3.length > 20) {
                            this.frameNodeArray3.splice(-20);
...
//# sourceMappingURL=0ea14f7c64967113b66bed4acdc34a138b91ceec.js.map