    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        async start() {
          ...
          let audioParam = this.AudioBg.getComponent(_crd && StoredPersistNode === void 0 ? (_reportPossibleCrUseOfStoredPersistNode({
            error: Error()
          }), StoredPersistNode) : StoredPersistNode);
...
//# sourceMappingURL=b62ea67ec34c45b58b1e5ea1b98361f9cf406867.js.map