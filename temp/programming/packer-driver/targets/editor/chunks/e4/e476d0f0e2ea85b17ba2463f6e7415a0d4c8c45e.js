                ...
                if (this.selectedNode) {
                  ...
                  if (!isNaN(selectedValue)) {
                    ...
                    if (!isCorrect) {
                      ...
                      labelBlock.color = Color.BLUE; // emtyNode -= 1;

                      if (value === 0 && !nodeState[this.selectedNode.name]) {
                        // if the node was previously empty and has not been updated before
                        emtyNode -= 1; // decrement emtyNode only if the node was empty and has not been updated before

                        nodeState[this.selectedNode.name] = true; // mark the node as updated
                      }
...
//# sourceMappingURL=e476d0f0e2ea85b17ba2463f6e7415a0d4c8c45e.js.map