                  ...
                  if (!nodeCheck[i][j].filled) {
                    if (isCorrect == true) {
                      ...
                      if (emtyNode === 0) {
                        ...
                        this.gameView.SelectNode.pause(); // this.gameView.BgMain.getComponent(AudioSource).pause();      
                    ...
                    if (this.redNumber == 4) {
                      ...
                      this.gameView.LoseAudio.play();
                      this.gameView.AudioBg.pause();
                      this.gameView.SelectNode.pause();
...
//# sourceMappingURL=b935a3b5449a511c734c391d560a51426c84c0ca.js.map