                  ...
                  if (!nodeCheck[i][j].filled) {
                    if (isCorrect == true) {
                      ...
                      if (emtyNode === 0) {
                        ...
                        this.gameView.WinAudio.play(); // this.gameView.BgMain.getComponent(AudioSource).pause();      
                      ...
                      if (this.redNumber == 4) {
                        ...
                        this.unschedule(this.updateTimer);
                        this.gameView.LoseAudio.play(); // this.gameView.BgMain.getComponent(AudioSource).pause();
...
//# sourceMappingURL=846207a1e0ecefc888a6a64be07dd7fb07f266b4.js.map