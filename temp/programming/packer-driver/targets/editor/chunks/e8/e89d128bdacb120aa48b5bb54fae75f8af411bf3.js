System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, VerticalTextAlignment, Label, Vec3, Color, Sprite, Button, director, AudioClip, AudioSource, Slider, Prefab, instantiate, SudokuCreator, GameView, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _dec25, _dec26, _dec27, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _descriptor19, _descriptor20, _descriptor21, _descriptor22, _descriptor23, _descriptor24, _descriptor25, _descriptor26, _crd, ccclass, property, GameController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'VerticalTextAlignment', 'Label', 'Vec3', 'Color', 'Sprite', 'Button', 'director', 'AudioClip', 'AudioSource', 'Slider', 'Graphics', 'SpriteFrame', 'loader', 'Prefab', 'instantiate']);
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "frameNode", _descriptor26, this);
        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              const nodeState = {}; // nodeSudoku.on(Node.EventType.TOUCH_END, () => {
              //     if (value === 0) {
              //         this.selectedNode = nodeSudoku;
              //         if (!nodeState[nodeSudoku.name]) {
              //             nodeState[nodeSudoku.name] = true; // đánh dấu rằng node đã được chọn và tạo prefabInstance
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    prefabInstance.setPosition(nodeSudoku.position);
                    nodeSudoku.parent.addChild(prefabInstance);
                    const prevSelectedNode = nodeState.__selectedNode__; // lấy node trước đó được chọn

                    if (prevSelectedNode) {
                      const prevPrefabInstance = nodeSudoku.parent.getChildByName(`${prevSelectedNode.name}_prefab`); // tìm prefabInstance của node trước đó

                      if (prevPrefabInstance) {
                        prevPrefabInstance.destroy(); // xóa prefabInstance của node trước đó (nếu có)
                      }
                    }

                    nodeState.__selectedNode__ = nodeSudoku; // lưu trữ node hiện tại được chọn
                  }
                }
              });
            }
        ...
        writable: true,
        initializer: null
      }), _descriptor26 = _applyDecoratedDescriptor(_class2.prototype, "frameNode", [_dec27], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
//# sourceMappingURL=e89d128bdacb120aa48b5bb54fae75f8af411bf3.js.map