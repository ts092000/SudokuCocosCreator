                  ...
                  if (!isCorrect) {
                    ...
                    if (this.redNumber == 4) {
                      ...
                      if (this.difficultyLevel === 0.2) {
                        this.timeBestArr.push(this.timeElapsed);
                        localStorage.setItem('bestTime1', JSON.stringify(this.timeBestArr));
                        this.winGame.active = true;
                      }

                      if (this.difficultyLevel === 0.3) {
                        this.timeBestArr.push(this.timeElapsed);
                        localStorage.setItem('bestTime2', JSON.stringify(this.timeBestArr));
                        this.winGame.active = true;
                      }
                    }
                  } else {
...
//# sourceMappingURL=fd07d45b7d0e0f88a17c67a9c152ccd369942bab.js.map