        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            ...
            for (let j = 0; j < 9; j++) {
              ...
              let prefabInstance = null; // Khởi tạo biến prefabInstance
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  this.selectedNode = nodeSudoku;
                  prefabInstance = instantiate(this.frameNode); // Đặt prefabInstance vào vị trí của node được chọn
...
//# sourceMappingURL=9b8c3347798a83f8802058a647ee3d26e115005c.js.map