          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (nodeSudoku.name !== "-" && this.selectedNode) {
                  this.selectedNode.getChildByName("labelBlock").getComponent(Label).string = "";
                }
...
//# sourceMappingURL=13282ae2045af17d43c198afa66847fe96bacec7.js.map