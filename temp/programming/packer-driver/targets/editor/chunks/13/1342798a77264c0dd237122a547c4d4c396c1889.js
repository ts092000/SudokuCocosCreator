                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (let i = 0; i < 9; i++) {
                      if (i !== row) {
                        ...
                        let frameNodeArray1 = this.frameNodeArray.splice(-20);
                        console.log(this.frameNodeArray);

                        if (this.frameNodeArray.length > 20) {
                          for (let i = 0; i < 20; i++) {
                            frameNodeArray1[i].destroy();
                    ...
                    for (let j = 0; j < 9; j++) {
                      if (j !== col) {
                        ...
                        this.frameNodeArray.push(nodePrefab);
                        console.log(this.frameNodeArray);
                        let frameNodeArray2 = this.frameNodeArray.splice(-20);

                        if (this.frameNodeArray.length > 20) {
                          for (let i = 0; i < 20; i++) {
                            frameNodeArray2[i].destroy();
                          } // this.frameNodeArray.length = 0;   
                    ...
                    for (let i = rowStart; i < rowStart + 3; i++) {
                      for (let j = colStart; j < colStart + 3; j++) {
                        if (i !== row && j !== col) {
                          ...
                          node.parent.addChild(nodePrefab);
                          this.frameNodeArray.push(nodePrefab);
                          let frameNodeArray3 = this.frameNodeArray.splice(-20);
                          console.log(this.frameNodeArray);

                          if (this.frameNodeArray.length > 20) {
                            for (let i = 0; i < 20; i++) {
                              frameNodeArray3[i].destroy();
                            } // this.frameNodeArray.length = 0;   
...
//# sourceMappingURL=1342798a77264c0dd237122a547c4d4c396c1889.js.map