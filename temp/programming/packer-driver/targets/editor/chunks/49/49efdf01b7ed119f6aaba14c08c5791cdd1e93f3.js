System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, VerticalTextAlignment, Label, Vec3, Color, Sprite, SpriteFrame, SudokuCreator, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, GameController;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'VerticalTextAlignment', 'Label', 'Vec3', 'Color', 'Sprite', 'SpriteFrame']);
        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              bgNode.parent = nodeSudoku;
              const bgSprite = bgNode.addComponent(Sprite);
              bgSprite.type = Sprite.Type.SLICED;
              bgSprite.sizeMode = Sprite.SizeMode.CUSTOM;
              bgSprite.spriteFrame = new SpriteFrame();
              bgSprite.spriteFrame.insetTop = 10;
              bgSprite.spriteFrame.insetBottom = 10;
              bgSprite.spriteFrame.insetLeft = 10;
              bgSprite.spriteFrame.insetRight = 10;
              bgSprite.color = Color.BLACK;
              bgNode.setContentSize(50, 50);
              ...
              bgNode.setPosition(25, -25);
              labelBlock.node.setPosition(25, -25);
            ...
            nodeNum.on(Node.EventType.TOUCH_END, () => {
              if (this.selectedNode) {
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  const labelBlock = this.selectedNode.getComponent(Label);
                  labelBlock.color = isCorrect ? Color.GREEN : Color.RED;
...
//# sourceMappingURL=49efdf01b7ed119f6aaba14c08c5791cdd1e93f3.js.map