    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        async start() {
          ...
          this.AudioBg = gameClientParams.AudioBg.getComponent(AudioSource); // let audioParam = audioNode.getComponent(StoredPersistNode);
...
//# sourceMappingURL=68821a7249cd40cec28150d5316a25bd925e9fe1.js.map