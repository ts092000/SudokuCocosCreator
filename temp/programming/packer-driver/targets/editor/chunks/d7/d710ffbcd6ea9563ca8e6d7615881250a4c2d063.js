    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        async start() {
          ...
          this.AudioBg = gameClientParams.AudioBg; // let audioParam = audioNode.getComponent(StoredPersistNode);
...
//# sourceMappingURL=d710ffbcd6ea9563ca8e6d7615881250a4c2d063.js.map