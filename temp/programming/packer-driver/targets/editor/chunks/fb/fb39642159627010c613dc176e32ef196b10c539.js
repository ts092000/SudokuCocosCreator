    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        async start() {
          ...
          let audioParam = audioNode.getComponent(_crd && StoredPersistNode === void 0 ? (_reportPossibleCrUseOfStoredPersistNode({
            error: Error()
          }), StoredPersistNode) : StoredPersistNode);
...
//# sourceMappingURL=fb39642159627010c613dc176e32ef196b10c539.js.map