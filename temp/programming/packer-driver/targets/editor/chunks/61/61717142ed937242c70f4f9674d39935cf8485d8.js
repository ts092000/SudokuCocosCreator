        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              let prevValue = "     "; // Khởi tạo biến lưu trữ giá trị trước đó của ô số
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  labelBlock.string = "-";
                  console.log(emtyNode);
                } else if (this.selectedNode !== nodeSudoku && prevValue !== "     ") {
                  this.selectedNode.string = prevValue;
...
//# sourceMappingURL=61717142ed937242c70f4f9674d39935cf8485d8.js.map