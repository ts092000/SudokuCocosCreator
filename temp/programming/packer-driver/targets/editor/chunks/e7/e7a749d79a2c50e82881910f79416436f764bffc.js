            ...
            for (let j = 0; j < 9; j++) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    nodeState[nodeSudoku.name] = true;
                    nodeState.prefabInstance = instantiate(this.frameNode);
              ...
              nodeNum.position = new Vec3(i % 3 * 100 + 80, Math.floor(i / 3) * -60, 0);
...
//# sourceMappingURL=e7a749d79a2c50e82881910f79416436f764bffc.js.map