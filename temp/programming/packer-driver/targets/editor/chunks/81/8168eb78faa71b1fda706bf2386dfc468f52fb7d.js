    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        async start() {
          ...
          let audioParam = find("AudioBg");
          let audioMute = find("AudioMute");
          let audioUnmute = find("AudioUnmute");
...
//# sourceMappingURL=8168eb78faa71b1fda706bf2386dfc468f52fb7d.js.map