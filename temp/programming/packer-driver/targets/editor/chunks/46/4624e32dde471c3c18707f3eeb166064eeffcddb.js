System.register(["__unresolved_0", "cc", "@algorithm.ts/sudoku", "__unresolved_1"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'VerticalTextAlignment', 'Label', 'Vec3', 'Color', 'Sprite', 'Button', 'director', 'AudioClip', 'AudioSource', 'Slider', 'Graphics']);
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            ...
            const width = 200; // độ rộng khung

            const height = 50; // chiều cao khung

            labelValue.setDimensions(width, height);
            labelValue.node.addComponent(Graphics);
            labelValue.node.getComponent(Graphics).fillColor = new Color(255, 255, 255);
            labelValue.node.getComponent(Graphics).lineWidth = 2;
            labelValue.node.getComponent(Graphics).strokeColor = new Color(0, 0, 0);
...
//# sourceMappingURL=4624e32dde471c3c18707f3eeb166064eeffcddb.js.map