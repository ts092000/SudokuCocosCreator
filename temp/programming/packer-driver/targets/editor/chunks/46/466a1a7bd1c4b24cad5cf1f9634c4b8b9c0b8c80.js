    ...
    execute: function () {
      ...
      _export("StoredPersistNode", StoredPersistNode = (_dec = ccclass('StoredPersistNode'), _dec(_class = class StoredPersistNode extends Component {
        ...
        async start() {
          ...
          this.AudioBg = this.AudioBg.getComponent(AudioSource);
          console.log(this.AudioBg); // this.gameClient = new GameClient("643fc5fe0a3bf6132391328d", "568a590d-f9d1-4a10-b59d-ea6e0d9e9786");
        }
...
//# sourceMappingURL=466a1a7bd1c4b24cad5cf1f9634c4b8b9c0b8c80.js.map