              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    console.log(this.nodePositionArray[this.nodePositionArray.length - 1]);
                    console.log(prefabInstance.position);

                    if (this.nodePositionArray[this.nodePositionArray.length - 1] != prefabInstance.position) {
                      console.log('1');
...
//# sourceMappingURL=6da62feb2b0d3735b750156722a22d64690d61e2.js.map