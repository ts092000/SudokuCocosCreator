        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              let prevValue = null; // Khởi tạo biến lưu trữ giá trị trước đó của ô số
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  labelBlock.string = "-";
                  console.log(emtyNode);
                } else if (this.selectedNode !== nodeSudoku && prevValue !== null) {
                  this.selectedNode = null;
...
//# sourceMappingURL=5f6d0c4faba1987af89a60979363407b93933f2f.js.map