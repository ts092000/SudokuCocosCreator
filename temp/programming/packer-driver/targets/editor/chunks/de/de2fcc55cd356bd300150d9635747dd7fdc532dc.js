      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            ...
            const _this = this; // let numberValue = find("NumberValueLabel");
            // console.log(nodeNum);
            ...
            let nodeNumLabel = this.node.getChildByName("NumberValueLabel");
            console.log(nodeNumLabel);
                  ...
                  if (!nodeCheck[i][j].filled) {
                    if (isCorrect == true) {
                      ...
                      if (emtyNode === 0) {
                        ...
                        this.gameView.SelectNode.volume = 0; // this.gameView.BgMain.getComponent(AudioSource).pause();      
                      ...
                      if (this.redNumber == 4) {
                        ...
                        nodeNumLabel.active = false; // this.gameView.BgMain.getComponent(AudioSource).pause();
...
//# sourceMappingURL=de2fcc55cd356bd300150d9635747dd7fdc532dc.js.map