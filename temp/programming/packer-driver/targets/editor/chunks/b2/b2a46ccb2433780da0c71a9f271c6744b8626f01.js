                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    for (let i = 0; i < 9; i++) {
                      if (i !== row) {
                        ...
                        console.log(this.frameNodeArray); // if (this.frameNodeArray.length > 20) {
                        //     for (let i = 1; i <= 20; i++) {
                    ...
                    for (let i = rowStart; i < rowStart + 3; i++) {
                      for (let j = colStart; j < colStart + 3; j++) {
                        if (i !== row && j !== col) {
                          ...
                          this.frameNodeArray = []; // if (this.frameNodeArray.length > 20) {
                          // }
...
//# sourceMappingURL=b2a46ccb2433780da0c71a9f271c6744b8626f01.js.map