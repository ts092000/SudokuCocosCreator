        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              let currentPrefabInstance = null;
                ...
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    if (currentPrefabInstance) {
                      currentPrefabInstance.destroy(); // xóa prefabInstance hiện tại (nếu có)
                    }

                    currentPrefabInstance = instantiate(this.frameNode);
                    currentPrefabInstance.setPosition(nodeSudoku.position);
                    nodeSudoku.parent.addChild(currentPrefabInstance);
                  }
                }
              });
            }
...
//# sourceMappingURL=c83fff3d90f63e1b705b3bce7a2a8aa02cc15e76.js.map