    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Label), _dec(_class = (_class2 = class GameController extends Component {
        ...
        createPuzzleBoard() {
          ...
          let solution = boardData.solution; // let puzzleGame: number[] = [];
            ...
            for (let j = 0; j < 9; j++) {
              ...
              nodeNum.on(Node.EventType.TOUCH_END, () => {
                if (this.selectedNode) {
                  ...
                  labelBlock.string = label.string; // labelBlock.color = Color.BLACK;
                }
              });
            }
          }
...
//# sourceMappingURL=7636af67e617112fd8c05882bf45065d73e46594.js.map