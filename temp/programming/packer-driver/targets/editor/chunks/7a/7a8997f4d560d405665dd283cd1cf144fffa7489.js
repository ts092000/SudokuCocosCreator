              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  ...
                  if (!nodeState[nodeSudoku.name]) {
                    ...
                    console.log(this.nodePositionArray[this.nodePositionArray.length - 2]);
                    console.log(this.frameNodeNumArray[this.frameNodeNumArray.length - 1]); // if(this.nodePositionArray[this.nodePositionArray.length - 2] != prefabInstance.position) {
                    //     console.log('1');
...
//# sourceMappingURL=7a8997f4d560d405665dd283cd1cf144fffa7489.js.map