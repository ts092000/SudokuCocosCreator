            ...
            for (let j = 0; j < 9; j++) {
              ...
              nodeNum.on(Node.EventType.TOUCH_END, () => {
                if (this.selectedNode) {
                  ...
                  labelBlock.string = label.string; // console.log(label.string);
                  // labelBlock.color = Color.BLACK;

                  const row = Math.floor(this.selectedNode.y);
                  const col = Math.floor(this.selectedNode.x);
...
//# sourceMappingURL=7a3baf0d019b3b78b37c1a3a1968424ff2ed0175.js.map