    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        easyLevelGame() {
          ...
          const bestTime = this.timeBestArr[0]; // Tạo bảng sudoku và chơi game
        ...
        mediumLevelGame() {
          ...
          // Lấy thời gian ngắn nhất cho mức độ chơi này
          const bestTime = this.timeBestArr[1]; // Tạo bảng sudoku và chơi game
        ...
        hardLevelGame() {
          ...
          // Lấy thời gian ngắn nhất cho mức độ chơi này
          const bestTime = this.timeBestArr[2]; // Tạo bảng sudoku và chơi game
                ...
                if (!isNaN(selectedValue)) {
                  ...
                  if (!isCorrect) {
                    ...
                    if (this.redNumber === 4) {
                      ...
                      this.volumeLose.play();
                      this.timeBestArr.push(this.timeElapsed);
                      localStorage.setItem('bestTime', JSON.stringify(this.timeBestArr[i]));
...
//# sourceMappingURL=9e24466e03b24b0a24ef2d05a0d3ce64cac5beb1.js.map