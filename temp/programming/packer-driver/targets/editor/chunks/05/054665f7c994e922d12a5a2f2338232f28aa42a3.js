      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(_crd && GameView === void 0 ? (_reportPossibleCrUseOfGameView({
        ...
        createPuzzleBoard() {
          ...
          for (let i = 0; i < 9; i++) {
            ...
            const spriteNodeNum = nodeNum.addComponent(Sprite);
            spriteNodeNum.type = Sprite.Type.SIMPLE;
            spriteNodeNum.sizeMode = Sprite.SizeMode.CUSTOM;
            spriteNodeNum.spriteFrame = null;
            spriteNodeNum.color = Color.BLACK;
            spriteNodeNum.node.setContentSize(80, 80);
...
//# sourceMappingURL=054665f7c994e922d12a5a2f2338232f28aa42a3.js.map