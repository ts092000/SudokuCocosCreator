          ...
          for (let i = 0; i < 9; i++) {
            for (let j = 0; j < 9; j++) {
              ...
              nodeSudoku.on(Node.EventType.TOUCH_END, () => {
                if (value === 0) {
                  this.selectedNode = nodeSudoku; // const prefabInstance = instantiate(this.frameNode);
                  // prefabInstance.setPosition(nodeSudoku.position);
                  // nodeSudoku.parent.addChild(prefabInstance);

                  setTimeout(() => {
                    if (this.selectedNode === nodeSudoku) {
...
//# sourceMappingURL=17ab1317505238852803bd8101b3c8806ade9153.js.map